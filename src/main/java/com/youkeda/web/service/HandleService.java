...
public class HandleService {
    ...
    static {
        ...
        public static Map<Integer,Integer> handle( int floor, int room, int capasity_need, int[][] a){
...
//                    if(a[floor+1][i] >= capasity_need ){
//                        list_2.add(i);
//                        list_length_2.add(Math.abs(room - i));
//                    }
//                }
//
//                for(int i = 0; i < list_2.size(); i++){
//                    int min = list_length_2.get(0);
//                    int min_index = list_2.get(0);
//                    if(list_length_2.get(i) <= min){
//                        min_index = list_2.get(i);
//                        min = list_length_2.get(i);
//                        map.put(floor+1,min_index);;
//                    }
//                }
